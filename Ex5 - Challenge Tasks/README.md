...
Make it so that when you double click the map, if the camping sites layer is on the map then remove it, and if the camping sites layer is not on the map then add it

Try this out yourself from scratch, or follow the steps below for help
...
4. Assuming your map has three layers (trails, camping sites, and the extra one you added), use an if/else statement to check if the number of layers is equal to 3

5. If the number of layers is 3, remove the camping sites layer from the map. Else add the camping sites layer to the map
...
Using this tutorial from earlier (https://developers.arcgis.com/javascript/latest/tutorials/style-a-feature-layer/) update the camping sites symbol to be a symbol of type simple-marker, and add labels the the camping sites layer which show the name of the camping site

-----

### Challenge Task 4

Find some other tutorials to use to add more features to your map. 
